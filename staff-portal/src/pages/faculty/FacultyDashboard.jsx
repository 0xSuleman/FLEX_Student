...
import {
  BookOpen, Calendar, Target, GraduationCap, FileX, BarChart3,
      ...
      <div className="col-span-12 xl:col-span-8 space-y-5">
        ...
        <div className="grid grid-cols-12 gap-5">
          ...
          <div className="col-span-6 sm:col-span-3 chunky-card chunky-card-hover p-5 relative overflow-hidden cascade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="relative">
              <div className="text-xs font-extrabold text-coffee uppercase tracking-widest">Attendance</div>
              <div className="text-[10px] text-cocoa/70 uppercase font-bold mt-2">Live Session</div>
              ...
              >
                <Target size={11} strokeWidth={3} /> Open
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="cascade-in" style={{ animationDelay: '0.04s' }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <QuickAction icon={Target}         label="Attendance" sub="Open Session"     onClick={() => navigate('/faculty/attendance')} />
